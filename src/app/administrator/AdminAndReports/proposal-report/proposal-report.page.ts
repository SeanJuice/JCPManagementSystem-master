...
@Component({
  ...
  templateUrl: './proposal-report.page.html',
  styleUrls: ['./proposal-report.page.scss'],
})
export class ProposalReportPage implements OnInit {
  ...
  GenerateChart()
  {
        ...
        this.firestore.collection("ProposalReporting").snapshotChanges().subscribe(items => {
          items.forEach(a => {
